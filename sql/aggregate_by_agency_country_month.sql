...
GROUP BY ts.awarding_agency_name, cc.country_code, SUBSTRING(ts.period_of_performance_star, 1, 4) , SUBSTRING(ts.period_of_performance_star, 6, 2),  ts.awarding_agency_name;
